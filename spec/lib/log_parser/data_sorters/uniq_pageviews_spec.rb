...
require 'log_parser/data_sorters/uniq_pageviews'

RSpec.describe LogParser::DataSorters::UniqPageviews do
  describe '.call' do
    it 'returns file sorted by visit_count' do
      filename = fixture('webserver.log')
      pageviews = LogParser::DataSorters::UniqPageviews.call(filename:)
      visit_string = LogParser::DataSorters::UniqPageviews::VISIT_STRING
